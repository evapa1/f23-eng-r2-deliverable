...
export default function SpeciesCard({ species, profile }: PropType) {
  // <SpeciesCard species = Species profile = " " />
      ...
      <div className="min-w-72 m-4 w-72 flex-none rounded border-2 p-3 shadow">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[600px]">
            <DialogHeader>
              {/* make it look nicer */}
              <DialogDescription style={mystyle}>Scientific name: {species.scientific_name}</DialogDescription>
              <DialogDescription style={mystyle}>Common name: {species.common_name}</DialogDescription>
              <DialogDescription style={mystyle}>Total Population: {species.total_population}</DialogDescription>
              <DialogDescription style={mystyle}>Kingdom: {species.kingdom}</DialogDescription>
              <DialogDescription style={mystyle}>Image URL: {species.image}</DialogDescription>
              <DialogDescription style={mystyle}>Description: {species.description}</DialogDescription>
            </DialogHeader>
          </DialogContent>
        </Dialog>
